...
/// <summary>
/// Adds the default Serilog logging configuration to the host.
/// </summary>
public static class LoggingExtension
{
    ...
    private static readonly Func<LogEvent, bool> _filterPredicate = exclusionPredicate =>
    {
        ...
        var isSuccessStatusCode = statusCode?.ToString() == "200";
        var isHealthCheckPath = path?.ToString().Contains("/health") ?? false;

        return isSuccessStatusCode && isHealthCheckPath;
    };
